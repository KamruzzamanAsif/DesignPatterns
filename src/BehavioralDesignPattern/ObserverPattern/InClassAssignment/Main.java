...
public class Main {
    public static void main(String[] args) {
        ConcreteSubject subject = new ConcreteSubject("src/BehavioralDesignPattern/ObserverPattern/InClassAssignment/Files/test.txt");
...
//        }
        ...
        // or we can change the file being monitored manually
        while(true) {}
    }
}
